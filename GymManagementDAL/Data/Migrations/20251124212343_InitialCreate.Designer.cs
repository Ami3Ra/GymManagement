...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20251124212343_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.HealthRecored", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("EndDateCostraint", "EndDate > StartDate");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.HealthRecored", b =>
                {
                    b.HasOne("GymManagementDAL.Entities.Member", null)
                        ...
                        .HasForeignKey("GymManagementDAL.Entities.HealthRecored", "Id")
