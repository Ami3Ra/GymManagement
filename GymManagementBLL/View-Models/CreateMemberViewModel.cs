...
namespace GymManagementBLL.View_Models
{
    internal class CreateMemberViewModel
    {
        ...
        [RegularExpression(@"^[a-zA-Z]\s+$",ErrorMessage ="Name Must Containe Letters Or Space Only")]
        public string Name { get; set; } = null!;

        [Required(ErrorMessage ="Email is Required")]
        [EmailAddress(ErrorMessage ="Invalid Email Format")] // App Validation
        [DataType(DataType.EmailAddress)] // UI Hint
        [StringLength(100,MinimumLength =2,ErrorMessage ="Email must be between 2 and 100")]
        ...
        [RegularExpression(@"^[a-zA-Z]\s+$", ErrorMessage = "City Must Containe Letters Or Space Only")]
        public string City { get; set; } = null!;

        [Required(ErrorMessage = "Street is Required")]
        [StringLength(30, MinimumLength = 2, ErrorMessage = "Street between 2 and 30")]
        [RegularExpression(@"^[a-zA-Z]\s+$", ErrorMessage = "Street Must Containe Letters Or Space Only")]
